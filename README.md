Celem projektu jest zbudowanie parsera kontenerów plikowych, zapisanych w formacie FAT12/16. Operacje te ograniczone są jedynie do wejścia (operacje zapisu nie są wymagane).
